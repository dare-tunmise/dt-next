...
const ProjectPost = () => {
  // 2. Use Next.js version of useParams
  ...
  // 3. Update document title once project is loaded
  useEffect(() => {
    if (project) {
      document.title = `${project.title} - Dare Tunmise`;
    }
  }, [project]);
